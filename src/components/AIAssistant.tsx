...
export function AIAssistant() {
  ...
  return (
    <>
      {/* Floating Button - positioned above settings button */}
      <button
        onClick={() => setIsOpen(true)}
        className={`fixed bottom-24 right-6 h-14 w-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:scale-105 active:scale-95 z-40 ${isOpen ? 'hidden' : ''}`}
      >
